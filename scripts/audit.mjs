...
await check('/api/auth/register', 503, ['veritabanı'], { method: 'GET' });
...
console.log('Mythborn Türkçe üyelik platformu route, içerik, hesap yaşam döngüsü ve API audit’i geçti.');
