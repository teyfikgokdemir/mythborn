...
await check('/api/search-index?locale=tr',200,['"count":215','"title":"Deli"','"title":"Akrep"','"title":"Su"','"title":"Yükselen"']);
await check('/api/search-index?locale=en',200,['"count":215','"title":"The Fool"','"title":"Scorpio"','"title":"Water"','"title":"Ascendant"']);
await check('/api/search-index?locale=el',200,['"count":215','"title":"Ο Τρελός"','"title":"Σκορπιός"','"title":"Νερό"','"title":"Ωροσκόπος"']);
