import worker from '../src/final-router.js';
...
await check('/',['knowledge-hub','Tarot Ansiklopedisi','Astroloji Kütüphanesi','Rüya Ansiklopedisi','Astroloji Sözlüğü']);
await check('/en',['KNOWLEDGE CENTRE','Tarot Encyclopedia','Birth Chart Library']);
await check('/el',['ΚΕΝΤΡΟ ΓΝΩΣΗΣ','Εγκυκλοπαίδεια Ταρώ','Βιβλιοθήκη Γενέθλιου Χάρτη']);
...
console.log('Final UX, daily-card persistence, knowledge-hub and multilingual llms audit passed.');
