...
await check('/',['knowledge-hub','Tarot Ansiklopedisi','Doğum Haritası Kütüphanesi','Rüya Ansiklopedisi','Astroloji Sözlüğü','desktop-explore']);
await check('/en',['KNOWLEDGE CENTRE','Tarot Encyclopedia','Birth Chart Library','Explore']);
await check('/el',['ΚΕΝΤΡΟ ΓΝΩΣΗΣ','Εγκυκλοπαίδεια Ταρώ','Βιβλιοθήκη Γενέθλιου Χάρτη','Εξερεύνηση','GR']);
...
console.log('Final UX, compact navigation, daily-card persistence, knowledge-hub and multilingual llms audit passed.');