...
if(paths.length!==expectedBaseSitemapRoutes+spanishRoutes.length)failures.push({path:'/sitemap.xml',failed:[`expected ${expectedBaseSitemapRoutes+spanishRoutes.length} unique URLs, received ${paths.length}`]});
