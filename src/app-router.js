...
function knowledgeHub(locale){
  const t=labels[locale],items=[
    ...
    ['25',t.glossary,'/astroloji-sozlugu'],['☽',t.vedic,'/vedik-astroloji'],['✦',t.advanced,'/advanced-astrology']
  ];
...
function footer(locale){
  const copy={
    ...
    es:{tag:'Un espacio ético y gratuito para el Tarot, la astrología y la reflexión simbólica.',readings:'Lecturas',learn:'Centro de conocimiento',search:'Buscar en el sitio',legal:'Legal',privacy:'Política de privacidad',terms:'Términos de uso',cookies:'Política de cookies',manage:'Gestionar preferencias de cookies',notice:'Aviso turco de protección de datos',rights:'Todos los derechos reservados.',note:'Para entretenimiento, educación y reflexión personal.'}
