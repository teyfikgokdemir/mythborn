...
function decorate(html,locale,path,accessState){
  ...
  const criticalAccessCss=`<style>html{scrollbar-gutter:stable}${path==='/'?'.premium-home-hero{grid-template-columns:minmax(0,.82fr) minmax(390px,1.18fr)!important}.hero-sky-card{min-height:744px}@media(max-width:1000px){.premium-home-hero{grid-template-columns:1fr!important}.hero-sky-card{min-height:0}}':''}</style>`;
  html=html
