...
import { calculateNatalChart,calculateCurrentSky } from './astrology.js';
const SITE='https://mythborn.co';
const discoveryRoutes=new Set(['/ruya-yorumlari','/burc-uyumu','/numeroloji','/ay-takvimi','/bugunun-gokyuzu']);
const routes=new Set(['/','/gunluk-kart','/deneyim','/tarot','/ask','/kariyer','/otuz-gun','/katina','/astroloji','/haftalik-burc','/ruya-yorumlari','/burc-uyumu','/numeroloji','/ay-takvimi','/bugunun-gokyuzu','/giris','/kayit','/hesabim','/yonetim','/gizlilik','/kvkk','/kullanim-kosullari','/cerezler']);
const publicRoutes=['/','/gunluk-kart','/tarot','/ask','/kariyer','/otuz-gun','/katina','/astroloji','/haftalik-burc','/ruya-yorumlari','/burc-uyumu','/numeroloji','/ay-takvimi','/bugunun-gokyuzu','/gizlilik','/kvkk','/kullanim-kosullari','/cerezler'];
...
'/api/astrology/current-sky':{scope:'current_sky',limit:120,windowSeconds:3600},
...
if(path==='/api/astrology/current-sky')return request.method==='GET'?calculateCurrentSky():method();
