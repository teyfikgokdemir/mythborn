  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .brand img {
      ...
      height: 34px;
      object-fit: contain;
      filter: drop-shadow(0 0 12px rgba(166,137,255,.22));
    }
    .signal { display: inline-flex; align-items: center; gap: 9px; }
    .signal::before {
      content: "";
      width: 7px;
      height: 7px;
    ...
    .clues { display: flex; justify-content: center; flex-wrap: wrap; gap: 10px; }
    .clue {
      padding: 11px 15px;
    ...
    .guess-card span { color: #756d7d; font-size: 10px; letter-spacing: .22em; text-transform: uppercase; }
    .guess-card strong {
      margin-top: 12px;
      font-family: Georgia,"Times New Roman",serif;
      font-size: 28px;
    ...
    .hint-stack { max-width: 760px; margin: 48px auto 0; text-align: left; }
    ...
    summary::after { content: "+"; color: var(--violet); font-size: 20px; font-weight: 400; }
    ...
    .access-box {
      ...
      border-radius: 28px;
      background: radial-gradient(circle at 50% 0,rgba(166,137,255,.16),transparent 55%),rgba(255,255,255,.025);
    ...
    .cta:hover { transform: translateY(-3px); box-shadow: 0 16px 50px rgba(166,137,255,.22); }
    .contact-note { margin: 22px 0 0; color: #797180; font-size: 12px; }
...
<body>
  <div class="shell">
    <header>
      <a class="brand" href="/" aria-label="Mythborn home">
        <img src="/images/mythborn-emblem.png" alt="" width="275" height="257">
        <span>MYTHBORN</span>
      </a>
    ...
    <main>
      ...
      <section class="reveal-section" id="what-is-mythborn" aria-labelledby="guess-title">
        ...
        <div class="hint-stack">
          <details><summary>Unlock fragment I</summary><p>It will arrive with a name, a number and a past.</p></details>
          <details><summary>Unlock fragment II</summary><p>Some will choose to wear it. Others will refuse to let anyone touch it.</p></details>
          <details><summary>Unlock fragment III</summary><p>The first release will not return in exactly the same form.</p></details>
        </div>
      </section>
    ...
    <footer>
      <span class="footer-brand"><img src="/images/mythborn-footer-emblem.png" alt="" width="226" height="230">© 2026 Mythborn</span>
