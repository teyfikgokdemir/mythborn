...
if(!document.querySelector('[data-discovery-styles]')){
  ...
  @media(max-width:1180px){.topbar .nav{gap:14px}.topbar .nav a{font-size:12px}.home .oracle-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.site-footer-grid{grid-template-columns:1.4fr repeat(2,1fr)}.site-footer-column:last-of-type{grid-column:2/-1}}
