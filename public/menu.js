...
if(!document.querySelector('[data-discovery-styles]')){
  ...
  @media(max-width:1180px){.topbar .nav{gap:14px}.topbar .nav a{font-size:12px}.site-footer-grid{grid-template-columns:1.4fr repeat(2,1fr)}.site-footer-column:last-of-type{grid-column:2/-1}}
  @media(max-width:900px){.compact-tool{grid-template-columns:1fr 1fr}.compact-tool .btn{grid-column:1/-1}.result-grid{grid-template-columns:1fr}.site-footer-grid{grid-template-columns:1fr 1fr}.site-footer-brand{grid-column:1/-1}.site-footer-column:last-of-type{grid-column:auto}}
  @media(max-width:620px){.compact-tool{grid-template-columns:1fr}.compact-tool .btn{grid-column:auto}.discovery-hero{padding-top:54px}.discovery-hero>h1{font-size:clamp(46px,15vw,70px)}.seo-faq h2{font-size:clamp(46px,14vw,68px)}.seo-faq summary{padding:20px 54px 20px 20px;font-size:15px}.seo-faq details p{padding:0 20px 22px}.site-footer{padding-bottom:90px}.site-footer-grid{grid-template-columns:1fr;gap:32px}.site-footer-brand,.site-footer-column:last-of-type{grid-column:auto}.site-footer-bottom{display:grid;gap:10px}}
  `;
  ...
  oldFooter.innerHTML=`
    <div class="site-footer-grid">
      <div class="site-footer-brand">
        <a class="site-footer-logo" href="/"><img src="/images/mythborn-emblem.png" alt=""><span>MYTHBORN</span></a>
        <p>Tarot, astroloji ve sembolik farkındalık araçlarını tek merkezde, ücretsiz ve sade bir deneyimle sunar.</p>
        <a href="mailto:info@mythborn.co">info@mythborn.co</a>
      </div>
      ...
      <div class="site-footer-column"><h3>Astroloji</h3><nav><a href="/astroloji">Doğum Haritası</a><a href="/haftalik-burc">Haftalık Burç</a><a href="/burc-uyumu">Burç Uyumu</a><a href="/ay-takvimi">Ay Takvimi</a></nav></div>
